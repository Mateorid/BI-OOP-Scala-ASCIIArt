...
//
//import ASCIIArtApp.UI.Controller.{Controller, GSFiltersImageController}
//
//class PathImgInputCommand(controller: GSFiltersImageController)
//    extends RegExpCommandHandler("--image (...\\S*)".r) {
//  override def commandName: String = "Path image input"
//
//  /**
